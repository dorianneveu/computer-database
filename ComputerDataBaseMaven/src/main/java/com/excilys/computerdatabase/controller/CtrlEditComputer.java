...
public class CtrlEditComputer {
	...
	public String edit(ModelMap model, @RequestParam(value=PARAM_COMPANY, required=false) String pCompany, @RequestParam(value=PARAM_DISCONTINUED, required=false) final String pDiscontinued
